...
export abstract class ProductsListPage extends GlobalPage {
  ...
  constructor(page: Page) {
    super(page);
    this.productsCount = this.page.locator(
      "div.category-type-products a.titleItemsCount",
    );
  ...
  async verifyTotalProducts(count: number): Promise<void> {
    expect(
      await this.productsCount.textContent(),
      "Validando o total de itens na lista de produtos.",
