...
export abstract class ProductDetailsPage extends GlobalPage {
    ...
    constructor(page: Page) {
        super(page)
        this.descriptionTitle = this.page.locator('div#product_2 div#Description h1')
        this.descriptionPrice = this.page.locator('div#product_2 div#Description > h2')
        this.descriptionColor = this.page.locator('div#product_2 div#Description div.colors > div:not(.ng-hide)')
        this.addToCartButton = this.page.getByText('ADD TO CART')
        this.checkoutPopUp = this.page.locator('button#checkOutPopUp')
        this.productEspecifications = this.page.locator('article div.list label.value')
    }
